...
@implementation QMCDMigrationManager
...
- (BOOL)QMCDMigrationManager_progressivelyMigrateStoreAtURL:(NSURL *)sourceStoreURL toStoreAtURL:(NSURL *)targetStoreURL ofType:(NSString *)type error:(NSError **)error
{
    ...
    if (NO == [self QMCDMigrationManager_getDestinationModel:&destinationModel
    ...
    if (![self QMCDMigrationManager_backupSourceStoreAtURL:sourceStoreURL
    ...
    return [self QMCDMigrationManager_progressivelyMigrateStoreAtURL:sourceStoreURL
