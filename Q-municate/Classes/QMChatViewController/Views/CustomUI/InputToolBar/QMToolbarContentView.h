...
FOUNDATION_EXPORT const CGFloat kQMToolbarContentViewHorizontalSpacingDefault;

/**
 *  A `QMToolbarContentView` represents the content displayed in a `QMInputToolbar`.
 ...
 */
@interface QMToolbarContentView : UIView
