...
@interface QMChatVC () <QMInputToolbarDelegate, QMKeyboardControllerDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate, UIActionSheetDelegate>
...
+ (UINib *)nib {
    ...
    return [UINib nibWithNibName:NSStringFromClass([QMChatVC class]) bundle:[NSBundle bundleForClass:[QMChatVC class]]];
}

+ (instancetype)messagesViewController {
    
    return [[[self class] alloc] initWithNibName:NSStringFromClass([QMChatVC class]) bundle:[NSBundle bundleForClass:[QMChatVC class]]];
}
