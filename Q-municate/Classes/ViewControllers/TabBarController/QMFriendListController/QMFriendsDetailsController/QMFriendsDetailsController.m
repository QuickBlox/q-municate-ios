...
#if !QM_BLOCK_USERS_ENABLED
    UITableViewCell *blockCell = [self.tableView cellForRowAtIndexPath:[NSIndexPath indexPathForRow:4 inSection:0]];
    [self cell:blockCell setHidden:YES];
#endif
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    switch( indexPath.row ){
        ...
        case QMCallTypeVideo: {
            ...
            break;
#if QM_BLOCK_USERS_ENABLED
        case QMCallTypeBlockUser:{
            QBPrivacyItem *item = [[QBPrivacyItem alloc] initWithType:GROUP_USER_ID valueForType:self.selectedUser.ID action:DENY];
