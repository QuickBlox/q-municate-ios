 ...
 */
- (void)chatDidLogin __attribute__((deprecated("Use chatDidConnect instead.")));
...
/**
 ...
 @param error Error
 */
- (void)chatDidNotLoginWithError:(QB_NULLABLE NSError *)error __attribute__((deprecated("Use 'chatDidNotConnectWithError:' instead.")));
