...
- (void)xmppStream:(QBXMPPStream *)sender didStreamResumed:(NSXMLElement *)element;
- (void)xmppStream:(QBXMPPStream *)sender didReceiveRequestAcknowledgementAnswerElement:(NSXMLElement *)element;
- (void)xmppStream:(QBXMPPStream *)sender didReceiveRequestAcknowledgementElement:(NSXMLElement *)element;
