 ...
 *
 *   ./image_to_code.py -i src/ImageResources/FBProfilePictureView/FBProfilePictureViewBlankProfilePortrait.png -c FBProfilePictureViewBlankProfilePortrait -o src
 *
 */
