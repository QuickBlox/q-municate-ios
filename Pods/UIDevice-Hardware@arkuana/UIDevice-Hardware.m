/*
 ...
 Modified some more by Ahmed Khalaf on 14/11/13
 */
...
+ (NSArray *)modelIdentifiersPerformantEnoughForBlur
{
    return @[   @"iPhone4,1",
                @"iPhone5,1",
                @"iPhone5,2",
...
- (BOOL)supportsBlur
{
    return [[UIDevice modelIdentifiersPerformantEnoughForBlur] containsObject:[self modelIdentifier]];
}

+ (BOOL)supportsBlur
{
    return [[UIDevice modelIdentifiersPerformantEnoughForBlur] containsObject:[[UIDevice currentDevice] modelIdentifier]];
}
@end
